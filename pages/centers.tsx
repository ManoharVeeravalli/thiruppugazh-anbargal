                ...
                <AccordionDetails>
                  <Box>
                    ...
                    <Typography paragraph>
                      ...
                      day.There are several classes conducted by anbars across
                      the city.
                    </Typography>
                    <TableContainer>
                      <Table>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Box>
                    ...
                    <br />
                    <Typography paragraph>
                      All events are well attended.By the grace of Senthil
                      andavan the thiruppugazh wave started by Guruji in Delhi
                      has spread far and wide and taken Chenna,i the land of
                      Tamilians by storm.There are a team of teachers ,the Doyen
                      among them is Smt Alamelu Santanam
                    </Typography>
                    <br />
                    <ContactPersons
                      location="Chennai"
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Box>
                    ...
                    <br />
                    <Typography paragraph>
                      Classes are conducted in several places throughout the
                      week.
                    </Typography>
                    <ContactPersons
                      location="Banglore"
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Box>
                    ...
                    <Typography paragraph>
                      Group efforts are taken for ‘kummi aattam’ in all
                      functions
                    </Typography>
                    <br />
                    <ContactPersons
